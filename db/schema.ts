...
export const companySettings = mysqlTable("company_settings", {
  ...
  // Company Control (v1.6): weitere registrierte Kennnummern
...
export const suppliers = mysqlTable(
  "suppliers",
  {
    ...
    notizen: text("notizen"),
    archiviert: boolean("archiviert").notNull().default(false),
    // Regelwerk (v1.6): Standard-Kategorie -> Konto/USt-Vorschlag im Post Manager
...
// Support-Meldungen: In-App-Reports (Frage/Problem/Idee/Fehler), lokal protokolliert
...
// ── E-Mail-Konten: mehrere Postfaecher fuer den E-Mail-Eingang (IMAP) ───────
...
// ── Kategorien: Schnellauswahl, die auf Konten des gewaehlten Rahmens mappt ──
...
// ── Banking (v1.3): Import-Chargen und persistente Bank-Transaktionen ──────
...
// ── Company Control (v1.6): freie Kennwerte mit optionaler Beleg-Verknuepfung ──
